...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--policy", required=True, help="Path to the runtime policy JSON file")
    return parser
...
def cmd_run(policy_path: str) -> int:
    try:
    ...
    for lineno, raw_line in enumerate(sys.stdin, start=1):
        ...
        try:
            ...
            print(json.dumps(error_outcome, sort_keys=True))
            continue
